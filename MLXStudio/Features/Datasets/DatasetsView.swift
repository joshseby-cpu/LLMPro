...
struct DatasetsView: View {
    ...
    private var huggingFaceBrowseCard: some View {
        HStack(alignment: .top, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Search HuggingFace's library directly. MLX Studio previews the first few rows, figures out the column shape automatically, and normalizes everything into the lesson format your model can learn from.")
    ...
    private func createBlankDataset() {
        ...
        let record = DatasetRecord(id: id, name: "New dataset", schema: .chat,
                                   ...
                                   notes: "Created in MLX Studio on \(Date().formatted(date: .abbreviated, time: .shortened))")
