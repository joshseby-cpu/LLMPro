...
extension Notification.Name {
    static let openTrainingWithModel = Notification.Name("MLXStudio.openTrainingWithModel")
    static let openChatWithModel = Notification.Name("MLXStudio.openChatWithModel")
}
