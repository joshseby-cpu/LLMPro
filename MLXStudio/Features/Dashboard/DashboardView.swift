...
struct DashboardView: View {
    ...
    private var hero: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("Pick a model, give it some lessons, then chat with it. MLX Studio handles the tricky parts.")
    ...
    private var nextStep: NextStep {
        ...
        if jobs.isEmpty {
            return NextStep(
                ...
                body: "You have everything you need. Open Teach to start a lesson — MLX Studio will pick the best settings for you.",
                icon: "3.circle.fill",
...
extension Notification.Name {
    static let switchSidebar = Notification.Name("MLXStudio.switchSidebar")
}
