...
This is the engine behind LLMPro's "Fusion" tab. The user picks several
...
def main() -> int:
    ...
    try:
        ...
        emit({"event": "error", "message": "mergekit not installed in the venv. Restart LLMPro so it can re-bootstrap the Python runtime."})
        return 6
    except Exception as exc:
