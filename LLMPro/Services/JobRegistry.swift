...
final class JobRegistry {
    ...
    /// PID belonging to some other binary (or a non-LLMPro python) is rejected.
    private func isProcessAlive(_ pid: Int32) -> Bool {
        ...
        //   ~/Library/Application Support/LLMPro/runtime/.venv/bin/python3.x
        return path.contains("python") && path.contains("llmpro")
    }
}
